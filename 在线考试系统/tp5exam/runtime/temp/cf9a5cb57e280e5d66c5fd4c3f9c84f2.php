<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpstudy\PHPTutorial\WWW\tp5exam\public/../application/admin\view\scroe\audit.html";i:1605839513;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5exam\application\admin\view\Common\head.html";i:1602636435;}*/ ?>
<!DOCTYPE html>
    ...
    <script>
		layui.use(['laydate','form'], function(){
			...
			form.on('submit(audit)', function(data){
	            //发异步，把数据提交给php
	            $.post("<?php echo url('Scroe/audit'); ?>",{data:filterData(data.field)}, function(data) {
					if (data.code == 1) {
