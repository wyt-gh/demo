<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"D:\phpstudy\PHPTutorial\WWW\tp5exam\public/../application/admin\view\scroe\teacher_index.html";i:1607332841;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5exam\application\admin\view\Common\head.html";i:1602636435;}*/ ?>
<!DOCTYPE html>
                                  ...
                                  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                	<tr>
                                      ...
                                      <td><?php echo $vo['add_time']; ?></td>                       
	                                    <td class="td-manage">              
		                                    <a title="阅卷"  onclick="xadmin.open('编辑','<?php echo url('Scroe/edit',['id'=>$vo['id'],'subject_id'=>$vo['subject_id']]); ?>',800,600)" href="javascript:;">
		                                       <i style="color: pink;">阅卷</i>
		                                    </a>
