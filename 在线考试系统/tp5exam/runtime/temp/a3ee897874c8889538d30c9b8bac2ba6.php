<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy\PHPTutorial\WWW\tp5exam\public/../application/admin\view\book\edit.html";i:1606467188;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5exam\application\admin\view\Common\head.html";i:1602636435;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                            	...
                            	<input type="hidden" id="cover_img" name="cover_img" value="<?php echo $book['cover_img']; ?>">
                            	<div class="layui-form-item">
                            		<label class="layui-form-label">
				                    	<span class="x-red">*</span>书名
				                    </label>
                            		<div class="layui-input-inline">
				           				<input type="text" name="book_name" required class="layui-input" placeholder="书籍名称" value="<?php echo $book['book_name']; ?>">
				           			</div>
                            	</div>
                            	<div class="layui-form-item">
                            		<label  class="layui-form-label">
                            		...
                            		<div class="layui-input-inline">
                            			<textarea name="synopsis" required placeholder="书籍简介" class="layui-textarea"><?php echo $book['synopsis']; ?></textarea>
                            		</div>
                            	</div>
                            	<div class="layui-form-item">
                            		<label  class="layui-form-label">
								...
								<div class="layui-form-item">
                            		<label  class="layui-form-label">
                            			<span class="x-red">*</span>是否完本
                            		</label>
                            		<?php if($book['end'] == '1'): ?>
                            		<input type="radio" name="end" value="0" title="否" >
									<input type="radio" name="end" value="1" title="是" checked>  
									<?php else: ?>
									<input type="radio" name="end" value="0" title="否" checked>
									<input type="radio" name="end" value="1" title="是" > 
									<?php endif; ?>          
                                </div>
								<div class="layui-form-item">
				                    ...
				                    <?php if(is_array($title) || $title instanceof \think\Collection || $title instanceof \think\Paginator): $i = 0; $__LIST__ = $title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
				                        <input type="checkbox" name="title[]" lay-skin="primary" title="<?php echo $t['title_name']; ?>" value="<?php echo $t['id']; ?>" <?php if(in_array(($t['id']), is_array($book['title'])?$book['title']:explode(',',$book['title']))): ?>checked<?php endif; ?>>
				           		...
				           		<div class="layui-form-item">
				           			...
				           			<div class="layui-input-inline">
		                                <select name="major_id" id="major" lay-filter="major" class="layui-input" required >
		                                	...
		                                	<option value="<?php echo $m['id']; ?>" <?php if($m['id'] == $book['major_id']): ?>selected<?php endif; ?>><?php echo $m['major_name']; ?></option>
		                                	<?php endforeach; endif; else: echo "" ;endif; ?>
		                                </select>
	                            	</div>
                            	</div>
    ...
    <script>
		layui.use(['laydate','form'], function(){
			...
			form.on('submit(edit)', function(data){
	            //发异步，把数据提交给php
	            $.post("<?php echo url('Book/edit'); ?>",{data:filterData(data.field)}, function(data) {
					if (data.code == 1) {
